...
#define nstates4	10	/* Capteur */
#define minseq4	195
#define maxseq4	203
#define endstate4	9

#define nstates3	81	/* Collecteur */
#define minseq3	115
#define maxseq3	194
#define endstate3	80

#define nstates2	69	/* Controleur */
#define minseq2	47
#define maxseq2	114
#define endstate2	68

#define nstates1	15	/* Simulateur */
#define minseq1	33
#define maxseq1	46
#define endstate1	14

#define nstates0	34	/* lanceur */
#define minseq0	0
#define maxseq0	32
#define endstate0	33
...
struct testArray { /* user defined type */
	int valeur[10];
};
#define PCapteur	((P4 *)this)
typedef struct P4 { /* Capteur */
...
#define Air4	(sizeof(P4) - Offsetof(P4, valeur) - 1*sizeof(int))

#define PCollecteur	((P3 *)this)
typedef struct P3 { /* Collecteur */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned dejaVuDeuxiemeValeur : 1;
	unsigned troisCapteursIdentiques : 1;
	int numCollecteur;
	int i;
	int valeurCommune;
	int valeur[2];
	int valeursDifferentes[2];
	int nbValeurs[2];
} P3;
#define Air3	(sizeof(P3) - Offsetof(P3, nbValeurs) - 2*sizeof(int))

#define PControleur	((P2 *)this)
typedef struct P2 { /* Controleur */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, retourCollecteur) - 5*sizeof(int))

#define PSimulateur	((P1 *)this)
typedef struct P1 { /* Simulateur */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Planceur	((P0 *)this)
typedef struct P0 { /* lanceur */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
