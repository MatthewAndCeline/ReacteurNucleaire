...
#define nstates3	20	/* Capteur */
#define minseq3	94
#define maxseq3	112
#define endstate3	19

#define nstates2	30	/* Collector */
#define minseq2	65
#define maxseq2	93
#define endstate2	29

#define nstates1	57	/* Controller */
#define minseq1	9
#define maxseq1	64
#define endstate1	56

#define nstates0	10	/* lanceur */
#define minseq0	0
#define maxseq0	8
#define endstate0	9
...
#define PCapteur	((P3 *)this)
typedef struct P3 { /* Capteur */
...
#define Air3	(sizeof(P3) - Offsetof(P3, valeur) - 1*sizeof(int))

#define PCollector	((P2 *)this)
typedef struct P2 { /* Collector */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, valeur4) - 1*sizeof(int))
...
#define Air1	(sizeof(P1) - Offsetof(P1, retourCollecteur) - 3*sizeof(int))
